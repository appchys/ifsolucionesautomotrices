...
interface OrdenClientePDFProps {
  orden: OrdenTrabajo;
  cliente: Cliente;
  vehiculo: Vehiculo;
  items: ItemOrden[];
...
export default function OrdenClientePDF({
  orden,
  cliente,
  vehiculo,
  items,
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.totalsContainer}>
          <View style={styles.totalsBox}>
            ...
            <View style={[styles.totalRow, { marginTop: 3 }]}>
              <Text style={styles.saldoPendienteLabel}>Saldo pendiente:</Text>
              <Text style={styles.saldoPendienteValue}>${saldoPendiente.toFixed(2)}</Text>
            </View>
          </View>
        </View>
      </Page>
